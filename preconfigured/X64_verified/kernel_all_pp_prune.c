# 0 "/workspace/seL4-c89/preconfigured/X64_verified/kernel_all_pp_prune_wrapper_temp.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 103 "/workspace/seL4-c89/preconfigured/X64_verified/gen_config/kernel/gen_config.h"
